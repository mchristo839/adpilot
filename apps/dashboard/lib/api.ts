...
export interface Creative {
  id: string; angle: string; primary_text: string; primary_text_variants: string[]; headline: string; headline_variants: string[]; description: string; cta: string;
...
export interface Campaign {
  ...
  landing_url: string; strategy_json: { angles: { name: string; hook: string }[]; targeting: { countries: string[]; age_min: number; age_max: number; interests: string[]; custom_notes: string }; placements: string } | null;
  approved_by: string | null; approved_at: string | null; last_error: string | null; dry_run: boolean; created_at: string;
